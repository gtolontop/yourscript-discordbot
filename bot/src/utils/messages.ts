...
/** Discord brand colors and standard status colors. */
export const Colors = {
  Primary: 0x5865f2,
  Success: 0x57f287,
  Warning: 0xfee75c,
...
interface SimpleMessageOptions {
  title?: string;
  description: string;
  footer?: string;
}
...
/**
 * Creates a Components V2 message with a styled container.
 */
...
/**
 * Creates a yellow warning message.
 */
